...
$wysj_plugin_url = trailingslashit( plugins_url( '', __FILE__ ) );
$wysj_plugin_url = str_replace( array( 'https://', 'http://' ), array( '//', '//' ), $wysj_plugin_url );
define( 'WYSJ_PATH', $wysj_plugin_url );
...
$wysj_uploads_url = trailingslashit( $wysj_super_serv_uploader['baseurl'].'/'.dirname( plugin_basename(__FILE__) ) );
$wysj_uploads_url = str_replace( array( 'https://', 'http://' ), array( '//', '//' ), $wysj_uploads_url );
define( 'WYSJ_UPLOADS_URL', $wysj_uploads_url );
define('WYSJ_VER','1.4');
